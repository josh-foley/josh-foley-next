...
export default function CategoriesPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-16">
      ...
      <ul className="flex flex-col divide-y-2 divide-retro-line">
        {categories.map(({ category, count }) => (
          <li key={category}>
            <Link
              href={`/categories/${toSlug(category)}`}
              className="flex items-center justify-between py-3 text-retro-stone transition hover:text-retro-ink"
            >
